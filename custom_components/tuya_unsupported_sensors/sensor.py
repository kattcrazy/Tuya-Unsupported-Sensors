...
def _get_friendly_name(property_code: str) -> str:
    ...
    name_mapping = {
        ...
        "energy_forword_a": "Forward Energy A",
        "energy_reverse_a": "Reverse Energy A",
        "energy_forword_b": "Forward Energy B",
        "energy_reserse_b": "Reverse Energy B",
        "forward_energy_total": "Forward Energy Total",
        "reverse_energy_total": "Reverse Energy Total",
        "frequency": "Frequency",
        "freq": "Frequency",
